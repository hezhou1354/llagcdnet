! --------------------------------------------------------------------------
! problassoNET.f90: the GCD algorithm for probit regression.
! --------------------------------------------------------------------------
! 
! USAGE:
! 
! call problassoNET (lam2, nobs, nvars, x, y, jd, pf, pf2, dfmax, &
...
! --------------------------------------------------
SUBROUTINE problassoNET (lam2, nobs, nvars, x, y, jd, pf, pf2, dfmax, pmax, &
...
! - - - allocate variables - - -
      ...
      CALL problassoNETpath (lam2, maj, nobs, nvars, x, y, ju, pf, pf2, dfmax, &
...
! - - - organize beta afterward - - -
      ...
      RETURN
END SUBROUTINE problassoNET
! --------------------------------------------------
SUBROUTINE problassoNETpath (lam2, maj, nobs, nvars, x, y, ju, pf, pf2, dfmax, &
...
! --------- computing lambda ----------------------------
    ...
    ! final update variable save results------------
      ...
      RETURN
! begin He
END SUBROUTINE problassoNETpath
! end He
